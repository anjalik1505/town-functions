 ...
 * 
 * Validates that:
 * 1. The user doesn't already have a pending invitation
 * 2. The user hasn't reached the maximum number of active invitations (5)
 * 3. The user hasn't reached the maximum number of friends (5)
 * 
