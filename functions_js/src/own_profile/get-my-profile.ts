...
export const getProfile = async (req: Request, res: Response) => {
  ...
  const response: ProfileResponse = {
    ...
    name: profileData[ProfileFields.NAME] || null,
    avatar: profileData[ProfileFields.AVATAR] || null,
    location: profileData[ProfileFields.LOCATION] || null,
    birthday: profileData[ProfileFields.BIRTHDAY] || null,
    notification_settings: profileData[ProfileFields.NOTIFICATION_SETTINGS] || null,
    summary: profileData[ProfileFields.SUMMARY] || null,
    suggestions: profileData[ProfileFields.SUGGESTIONS] || null,
